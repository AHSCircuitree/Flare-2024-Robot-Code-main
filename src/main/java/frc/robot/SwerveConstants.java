...
public final class SwerveConstants {
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 1.7; //change back to 4.8 after may 24 2024
    public static final double kMaxAcceleration = 1.85;
    public static final double kMaxAngularSpeed = 2 * Math.PI; // radians per second
    public static final double kMaxAngularAcceleration = 4;

    // Chassis configuration
    public static final double kTrackWidth = 0.419;
    // Distance between centers of right and left wheels on robot
    public static final double kWheelBase = 0.419;
    ...
    public static final int gyroCanId = 37;
